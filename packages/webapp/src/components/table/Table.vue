<template>
    <div class="app-data-table">
        ...
        <div class="app-data-table-body">
            <el-table ref="tableRef" class="w-full" :data="model.items" :row-key="rowKey" @selectionChange="handleSelectionChange" v-loading="model.loading">
                <template #default>
        ...
        <div class="app-data-table-footer">
            <el-pagination v-model="tablePagination.current" :total="tablePagination.total" :page-size="tablePagination.pageSize" @change="handlePageChange" />
        </div>
    </div>
</template>
...
.app-data-table .app-data-table-toolbar {
    @apply mb-4 w-full;
}

.app-data-table .app-data-table-body {
    @apply w-full;
}

.app-data-table .app-data-table-footer {
