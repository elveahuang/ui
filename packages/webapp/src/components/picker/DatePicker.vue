<template>
    <el-date-picker v-model:value="value" :allow-clear="allowClear" :allow-empty="allowEmpty" :show-time="showTime" :format="format" @change="onChange" />
</template>
<script setup lang="ts">
import { DATE_PATTEN, DATE_TIME_PATTEN, formatDate, formatDatetime, formatTime, parseDate, parseDatetime, TIME_PATTEN } from '@commons/core/utils/date';
