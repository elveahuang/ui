<template>
    <app-page-header :title="$t('common.banner_management')" />
            ...
            <div class="app-modal-body">
                <el-form ref="entityFormRef" label-width="auto" :model="entityFormModel" :rules="entityFormRules" @finish="handleFormSubmit">
                    ...
                    <el-form-item :label="$t('common.field_publish_period')">
                        <app-date-range-picker v-model:from="entityFormModel.startDatetime" v-model:to="entityFormModel.endDatetime" type="datetime" />
                    </el-form-item>
...
import { announcementDeleteApi, announcementSaveApi } from '@commons/core/api/admin/announcement.ts';
import { bannerListApi } from '@commons/core/api/admin/banner.ts';
import { announcementDetailsApi } from '@commons/core/api/home/announcement.ts';
...
import { AppPageHeader, AppTable } from '@commons/webapp/components';
...
onMounted(async (): Promise<void> => {
    log('Page <<UserSessionIndexPage>> mounted.');
});
</script>
